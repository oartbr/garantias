...
// Use this to import the right object type for the service: import { SKU } from "../types/sku";
...
// ## The response should be a Nota object.
// ## Here we define the type of the expected object.
type Nota = {
  notaId: string;
  name: string;
  description?: number;
